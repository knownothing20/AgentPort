...
AI: 好的，我来帮你设置连接。
    [调用 remote_setup(host="192.168.1.100", username="root")]
...
AI: 好的，我来帮你设置连接。
    [调用 remote_setup(host="192.168.1.100", username="yourname")]
...
AI: [调用 remote_setup(host="192.168.1.100", username="yourname", privateKey="~/.ssh/id_ed25519")]
    ✅ SSH 连接测试成功
    ⏳ 正在部署守护进程...
    ✅ 守护进程已启动
